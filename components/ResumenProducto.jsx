...
const ResumenProducto = ({producto}) => {
    ...
    const { handleEditarCantidades, handleElminarProducto } = useQuiosco();

  return (
    <div key={producto.id} className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        ...
        <button
            ...
            onClick={() => handleElminarProducto(producto.id)}
        >
